...
const HomeBackground = lazy(() => import('../components/HomeBackground').then((module) => ({ default: module.HomeBackground })))
    ...
    >
      ...
      <div className="phone-shell" style={{ containerType: 'inline-size' }}>
        ...
        <div className="absolute inset-0">
          <Suspense fallback={<div className="home-background-placeholder" aria-hidden="true" />}>
            <HomeBackground />
          </Suspense>
        </div>
        ...
        <div className="absolute inset-0 overflow-y-auto">
          ...
          >
            ...
            <button type="button" className="home-feedback-button" onClick={() => setShowFeedback(true)}>💬 SHARE FEEDBACK</button>
